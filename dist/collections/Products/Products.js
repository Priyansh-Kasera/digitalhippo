...
var syncUser = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var fullUser, products, allIDs_1, createdProductsId, dataToUpdate;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    createdProductsId = allIDs_1.filter(function (id, index) { return allIDs_1.indexOf(id) === index; });
                    dataToUpdate = __spreadArray(__spreadArray([], createdProductsId, true), [doc.id], false);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            updated = __assign(__assign({}, data), { stipeId: createdProduct.id, priceId: createdProduct.default_price });
                            return [2 /*return*/, updated];
                        case 2:
                            if (!(args.operation === "update")) return [3 /*break*/, 4];
                            data = args.data;
                            return [4 /*yield*/, stripe_1.stripe.products.update(data.stipeId, {
                                    name: data.name,
                                    default_price: data.priceId,
                                })];
                        case 3:
                            updateProduct = _a.sent();
                            updated = __assign(__assign({}, data), { stipeId: updateProduct.id, priceId: updateProduct.default_price });
                            return [2 /*return*/, updated];
