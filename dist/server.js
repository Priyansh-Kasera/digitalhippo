    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                app.post("/api/webhooks/stripe", webhookMiddleware, webHooks_1.stripWebHookHandler);
            ...
            case 1:
                ...
                next_utils_1.nextApp.prepare().then(function () {
                    ...
                    app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            payload.logger.info("Next.js App URl : ".concat(process.env.NEXT_PUBLICE_SERVER_URL));
                            return [2 /*return*/];
                        });
                    }); });
                });
